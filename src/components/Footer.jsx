...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-b from-slate-900 to-slate-950 border-t border-slate-800/50 py-16 w-full">
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={index}>
                  <a 
                    href={item.href} 
                    className="text-slate-400 hover:text-purple-400 hover:translate-x-1 transition-all duration-300 flex items-center"
                  >
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-4">
                ...
                >
                  <div className="w-12 h-12 bg-gradient-to-r from-blue-600 to-blue-500 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-lg shadow-blue-500/25">
              ...
              <div className="flex items-center space-x-4">
                <a 
                  ...
                  className="flex items-center space-x-3 group"
                >
                  <div className="w-12 h-12 bg-gradient-to-r from-gray-700 to-gray-600 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-lg shadow-gray-600/25">
                    <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-slate-800/50 pt-8 mt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-slate-400 text-sm mb-4 md:mb-0">
              <p>© 2024 Chandrashekar Hanumanthu. All rights reserved.</p>
            </div>
            <div className="flex items-center space-x-6">
              <a 
                href="mailto:hanumanthuchandrashekar972@gmail.com" 
                className="text-slate-400 hover:text-purple-400 transition-all duration-300 flex items-center group"
              >
